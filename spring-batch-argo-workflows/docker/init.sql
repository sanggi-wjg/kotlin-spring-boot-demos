-- Spring Batch 6 MySQL Schema
-- https://github.com/spring-projects/spring-batch (schema-mysql.sql)
...
(
    ...
    `name`       VARCHAR(254) NOT NULL COMMENT '이름',
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='테스트 유저 데이터';
